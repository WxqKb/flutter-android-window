...
class MainApi {
  ...
  Future<void> open(String arg_entry, int arg_width, int arg_height, int arg_x, int arg_y, bool arg_focusable, bool arg_draggable) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.MainApi.open', codec, binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
        await channel.send(<Object>[arg_entry, arg_width, arg_height, arg_x, arg_y, arg_focusable, arg_draggable]) as Map<Object?, Object?>?;
    if (replyMap == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',
