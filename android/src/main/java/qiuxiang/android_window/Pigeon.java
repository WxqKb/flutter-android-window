...
public class Pigeon {
  ...
  public interface MainApi {
    ...
    @NonNull void open(String entry, Long width, Long height, Long x, Long y, Boolean focusable, Boolean draggable);
    @NonNull void close();
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              ...
              Boolean draggableArg = (Boolean)args.get(6);
              if (draggableArg == null) {
                throw new NullPointerException("draggableArg unexpectedly null.");
              }
              api.open(entryArg, widthArg.longValue(), heightArg.longValue(), xArg.longValue(), yArg.longValue(), focusableArg, draggableArg);
              wrapped.put("result", null);
            }
            catch (Error | RuntimeException exception) {
              wrapped.put("error", wrapError(exception));
